...
// //arguments keyword
// //argument keyword represent the list of arguments received in the current function.
// //We can access each argument value by using index, argument[0], argument[1]......
// //Below function calculates all the number
...
// console.log(getBill(22));
// console.log(getBill(1,2,3,4,5));
// console.log(getBill(22,33));

// //callback function
// //a function that is passed as argument to another function and get involved in that
// //another function
...
// function fnc(name, age, fncRef) {
//     name = "Mr." + " " + name;
//     fncRef(name, age); //calls callback
// }

// fnc("Sam", 34, callback1);
// fnc("Kiran", 45, callback2);

// //default arguments
// let getPrice = function (price, taxRate = 18) {
//     let netPrice = price + (price * taxRate) / 100;
//     return netPrice;
// }

// let result = getPrice(2000, 10);
// console.log(result);

// let price = getPrice(4000);
// console.log(price);
